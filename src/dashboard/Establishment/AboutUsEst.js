...
export default function AboutUsEst() {
  return (
    <WrapperDashEst>
      <div className="flex  flex-col px-9 pt-10 pb-6 rounded-3xl bg-zinc-50 max-md:px-5 max-md:max-w-full">
        ...
        <div className="flex flex-col px-10 py-12 mt-8 text-sm leading-6 bg-white rounded-3xl shadow-2xl text-neutral-700 max-md:px-5 max-md:max-w-full">
          <div className={`text-2xl text-red-500 text-left max-md:max-w-full} ${styles.header}`}>
          ...
          <div className="flex pt-5">
            <div className="pr-5">
              <img
                loading="lazy"
                src="/images/completeProfile/fb.png"
            ...
            <div className="pr-5">
              <img
                loading="lazy"
                src="/images/completeProfile/instagram.png"
                className="shrink-0 w-10 aspect-square"
              />
            </div>
            <div className="pr-5">
              <img
                loading="lazy"
                src="/images/completeProfile/in.png"
                className="shrink-0 w-10 aspect-square"
              />
            </div>
            <div className="pr-5">
              <img
                loading="lazy"
                src="/images/completeProfile/imageX.png"
                className="shrink-0 w-10 aspect-square"
              />
            </div>
          </div>
