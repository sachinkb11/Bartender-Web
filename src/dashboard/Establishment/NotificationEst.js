...
export default function NotificationEst(props) {
    return (
        <div className=" absolute top-[70px] right-[100px] z-100 overflow-y-scroll h-[400px] w-[300px]  flex flex-col mt-5 pt-9 ml-20 pb-7  bg-gray-100 rounded-3xl border border-solid border-neutral-200 max-w-[390px]">
