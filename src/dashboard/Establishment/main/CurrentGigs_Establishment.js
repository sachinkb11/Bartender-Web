...
function CurrentGigsEstablishment(props) {
        ...
        <div className="max-md:max-w-full flex-1 ">
          <div className="bg-white rounded-3xl self-center  shadow-2xl pt-7 px-4 pb-6 ">
            <div className="flex gap-5 ml-14 max-w-[500px]  py-1 px-1  text-base leading-5 text-center max-lg:rounded-[10px] bg-white border border-gray-200 border-solid rounded-[100px] text-neutral-700 max-2xl:flex-wrap">
              <div className="flex gap-2 self-stretch px-9 py-2.5  font-medium text-white whitespace-nowrap bg-red-500 rounded-[100px] max-md:px-5">
                <img
                  loading="lazy"
                  src="/images/completeProfile/cocktail.png"
                  className="shrink-0 w-7 aspect-square"
                />
                <div className="grow text-sm mt-1">Current Gigs</div>
              </div>
              <Link
              ...
              {item.map(() => {
                return (
                  <div className=" relative flex max-w-[200px]  pl-1 flex-col grow  pt-1.5 pb-1 rounded-xl  border border-solid bg-zinc-50 border-neutral-200 max-md:mt-5">
                    ...
                    />
                    <div className=" absolute top-4 right-4  px-3 py-[1px] text-xs font-medium text-black whitespace-nowrap bg-white rounded-xl border border-amber-300 border-solid">
                      Ongoing
                    </div>
                    <span className=" flex text-blue-500 absolute top-[37%] left-[50%]  pl-1 ">
                      <img
                        loading="lazy"
                    ...
                    <span className=" flex text-blue-500 absolute top-[37%] left-[58%]  pl-1 ">
                      <img
                        loading="lazy"
                    ...
                    <span className=" flex text-blue-500 absolute top-[37%] left-[66%]  pl-1 ">
                      <img
                        loading="lazy"
