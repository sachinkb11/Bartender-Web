      ...
      <div className="max-md:max-w-full flex-1 ">
          ...
          <div className="bg-white rounded-3xl self-center   shadow-2xl mt-5 pt-7 px-4 pb-6 ">
            <div className="flex gap-5 ml-14 max-w-[500px]  py-1 px-1  text-base leading-5 text-center max-lg:rounded-[10px] bg-white border border-gray-200 border-solid rounded-[100px] text-neutral-700 max-2xl:flex-wrap">
              ...
              <Link to={"/NewOpportunities"} className="flex-auto text-sm self-stretch my-auto">
                 New Opportunities
              </Link>
              <div className="flex gap-2 self-stretch px-3 py-2.5 max-lg:ml-10 font-medium text-white whitespace-nowrap bg-red-500 rounded-[100px] max-md:px-5">
                ...
                />
                <div className=" mt-1 ">Past Gigs</div>
              </div>
            ...
            <div className="flex gap-5  justify-between  mt-5 w-full max-md:flex-wrap max-md:max-w-full">
              ...
              <img
                onClick={() => setShowFilter((setShowFilter) => !setShowFilter)}
                loading="lazy"
                src="/images/completeProfile/filter.png"
                className="shrink-0 aspect-[1.06] mt-1.5 h-[40px] w-[40px]"
              />
            </div>
            {/* ... */}
              ...
              {item.map(() => {
                return (
                  ...
                  <div className="flex  mt-1 text-xs text-neutral-700">
                    ...
                    />
                    <div className="flex-auto pl-1 whitespace-nowrap">
            ...
            <div className=" relative flex max-w-[200px] pl-1 mt-3  flex-col grow  pt-1.5 pb-1 rounded-xl  border border-solid bg-zinc-50 border-neutral-200 max-md:mt-5">
                  <img
                    loading="lazy"
                    src="/images/completeProfile/bar_Img2.png"
                    className=" w-full shadow-lg aspect-[2]"
                  ...
                  <div className="flex gap-1 mt-2.5 text-xs text-red-500">
<img
  loading="lazy"
...
<div className="flex-auto tracking-tighter">
  Your Earnings: $500 !not processed
</div>
</div>
                  </div>
          </div>
...
<img
  ...
  className=" w-3 h-3 mt-[2px]"
/>
<div className="flex-auto whitespace-nowrap tracking-tighter">
  Your Earnings: $500 !not processed
</div>
</div>