    ...
    <WrapperDash>
      ...
      <div className="flex mt-7">
        ...
        <div className=" relative flex flex-col grow items-start pt-5 pr-7 pb-20 pl-4 w-full bg-white rounded-3xl shadow-2xl max-md:pr-5 max-md:mt-6 max-md:max-w-full">
          ...
          <div className="flex  items-center self-center py-1 pl-10 mt-3.5 px-2 max-w-full text-sm leading-5 bg-white border border-gray-200 border-solid rounded-[100px] text-neutral-700 w-[550px] max-md:flex-wrap max-md:pl-5">
            <Link className="grow self-stretch my-auto" to="/GigCancel"> About The Gig</Link>
            <Link className="flex-auto self-stretch my-auto" to="/EstaCancel"> About Establishment</Link>

            <div className="flex gap-2.5 self-stretch px-11 py-3.5 font-medium text-white whitespace-nowrap bg-red-500 rounded-[100px] max-md:px-5">
              <img
                loading="lazy"
                src="/images/completeProfile/cocktail.png"
                className="shrink-0 w-6 aspect-square"
              />
              <div className="my-auto">Benefits</div>
            </div>
          </div>
          ...
          <button className="justify-center self-center px-5 py-5 mt-40 w-[70%] text-sm text-center text-black bg-amber-300 rounded-[92.207px] max-md:max-w-full">
            Cancel Booking
          </button>
        </div>
        {/* second */}
