...
export default function LoginEst(props) {
  ...
  function goToForgotPass() {
    navigate("/ForgotPassEst");
  }
  function GoToBarteder() {
    navigate("/");
  }
  return (
    <WrapperEst>
      <div className="flex flex-col items-center bg-white border-solid border-[5.241px] border-[color:var(--ffcc-42,#FFCC42)] rounded-[41.924px] max-md:px-5 max-md:max-w-full">
        ...
        <div className="flex flex-col items-center ">
          <div className="flex gap-5 justify-between px-1 py-1 mt-3 text-base shadow-[0_1px_5px_rgb(0,0,0,0.2)] leading-6 text-center whitespace-nowrap bg-white rounded-[132.798px]">
           
            <Link to={"/"} className="my-auto text-neutral-400 px-5">Bartender</Link>
           
            <div className=" justify-center px-4 py-3 font-medium text-white bg-red-500 rounded-[132.798px] max-md:px-5">
              Establishment
            </div>
          </div>
          ...
          <button className="justify-center p-3 w-[85%] mt-4 text-small text-center text-black bg-amber-300 rounded-[124.047px] max-md:px-5 max-md:max-w-full my-3">
            Sign In
          </button>
          <button
          ...
          <div className="text-small my-4 text-center text-red-500 ">
            ...
            <Link to="/SignUpest">Sign Up</Link>
          </div>
        </div>
      </div>
    </WrapperEst>
