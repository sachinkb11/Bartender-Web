...
export default function SignUpEst(props) {
    ...
    <WrapperEst>
      <div className="flex flex-col items-center bg-white border-solid border-[5.241px] border-[color:var(--ffcc-42,#FFCC42)] rounded-[41.924px] max-md:px-5 max-md:max-w-full">
        ...
        <div className="flex gap-5 justify-between px-1 py-1 mt-3 text-base shadow-[0_1px_5px_rgb(0,0,0,0.2)] leading-6 text-center whitespace-nowrap bg-white rounded-[132.798px]">
            ...
            <Link to={"/SignUp"} className="my-auto text-neutral-400 px-5">Bartender</Link>
          ...
          <img
        loading="lazy" 
        src="/images/signupEstProfile.png"
        className="mt-6 max-w-full aspect-square w-[118px]"
      />
          ...
          <div className="self-center mt-3 text-small text-center text-black-500 w-[323px]">
            ...
            <Link className="text-red-500" to="/TermConitionEst">
              Terms and Condition
            </Link>
          </div>
