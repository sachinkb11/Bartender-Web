...
export default function CodeVerifyPass(props) {
    ...
    return (
        ...
        <div className={styles.header}>
            ...
            <button onClick={goToCreatePass} className="justify-center p-3 w-[90%] text-small  text-center text-black bg-amber-300 rounded-[124.047px] max-md:px-5 max-md:max-w-full my-3 ">
