  ...
  return (
    <Wrapper>
      <div className="flex flex-col w-[550px] p-5 items-center bg-white border-solid border-[5.241px] border-[color:var(--ffcc-42,#FFCC42)] rounded-[41.924px] max-md:px-5 max-md:max-w-full}">
        ...
        <button onClick={GoTocodeverify} className="justify-center p-3 text-small w-[87%] mt-4 mb-6 text-center text-black bg-amber-300 rounded-[124.047px] max-md:px-5 max-md:max-w-full my-3 ">
          Send OTP
        </button>
      </div>
    </Wrapper>
