...
export default function CodeVerifyAccount(props) {
    ...
    return (
        <Wrapper>
            <div className="flex flex-col items-center px-11 pt-12 pb-8 bg-white border-solid border-[5.241px] border-[color:var(--ffcc-42,#FFCC42)] rounded-[41.924px] max-md:px-5 max-md:max-w-full">
                ...
                <button onClick={goToSuccess} className="justify-center p-3 w-[90%] text-small text-center text-black bg-amber-300 rounded-[124.047px] max-md:px-5 max-md:max-w-full mt-3 ">
