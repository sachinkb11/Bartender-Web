...
export default function PendingPayment({ menu }) {
        ...
        <div className="flex flex-col px-5 py-12 mt-8 text-sm leading-6 bg-white rounded-3xl shadow-2xl text-neutral-700 max-md:px-5 max-md:max-w-full">
          ...
          <div className="flex justify-between text-center">
            ...
            <div className="relative">
              ...
              />
              <span className="absolute right-0 top-5 text-lg ">&#10022;</span>
              <span className="absolute right-0 top-[60px] text-lg">
                &#10022;
              </span>
              <span className="absolute left-2 top-8 text-lg  ">&#10022;</span>
            </div>
            ...
            {menu.map((item,index) => {
              return (
                ...
                >
                  ...
                  <div className="mt-1.5 text-[13.5px] text-neutral-400">
                    {item.PaymentDetail}
                    {index==1 && <div className="">8 days are past! <span className="text-red-500 font-semibold">Send Reminder</span> </div>}
                  </div>
                </div>
              );
            })}
