    ...
    <WrapperDash>
      ...
      <div className="flex mt-7">
        ...
        <div className=" relative flex flex-col grow items-start pt-5 pr-7 pb-20 pl-4 w-full bg-white rounded-3xl shadow-2xl max-md:pr-5 max-md:mt-6 max-md:max-w-full">
          ...
          <div className="flex gap-5 justify-between items-center self-center px-10 py-1 mt-3.5 max-w-full text-sm leading-5 bg-white border border-gray-200 border-solid rounded-[100px] text-neutral-700 w-[556px] max-md:flex-wrap max-md:px-5">
            <div className="self-stretch my-auto">About The Gig</div>
            <div className="flex gap-2.5 self-stretch px-3 py-3.5 font-medium text-white bg-red-500 rounded-[100px] max-md:px-5">
              <img
                loading="lazy"
                src="/images/completeProfile/cocktail.png"
                className="shrink-0 w-6 aspect-square"
              />
              <div className="flex-auto my-auto">About Establishment</div>
            </div>
            <div className="self-stretch my-auto text-center">Benefits</div>
          </div>
          ...
          <button className="justify-center self-center px-5 py-5 mt-10 w-[70%] text-sm text-center text-black bg-amber-300 rounded-[92.207px] max-md:max-w-full">
            Cancel Booking
          </button>
        </div>
        {/* second */}
