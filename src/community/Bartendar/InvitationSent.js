...
export default function InvitationSent({ menu1 }) {
          ...
          <div className="flex flex-col items-center self-center px-16 pt-4 mt-7 max-w-full text-base whitespace-nowrap border-b border-gray-200 border-solid w-[385px] max-md:px-5">
            <div className="flex flex-col max-w-full w-[173px]">
              <div className="flex gap-5 justify-between">
                <Link to={"/InvitationRecived"} className=" ">Received</Link>
                <div className="text-black font-semibold text-red-500">Sent</div>
              </div>
              <div className="shrink-0 mt-3 ml-[115px] bg-red-500 w-[80px] border-red-500 border-solid border-[3px] h-[3px]" />
            </div>
          </div>
          {/* headerComplete */}
