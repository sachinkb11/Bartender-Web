...
function SkillInterest() {
      ...
      <div className={`text-2xl leading-9 text-center  } ${style.header}`}>
      ...
      <div className={`mt-16 text-2xl leading-9 text-center text-black capitalize max-md:mt-10 ${style.header}`}>
      ...
      <Link to={"/LinkDocument"} className="justify-center px-5 py-5 mt-10 text-sm w-[55%] text-center text-black bg-amber-300 rounded-[92.207px] max-md:max-w-full">
        Save & Next
      </Link>
